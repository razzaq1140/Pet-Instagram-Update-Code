...
class FeedPostWidget extends StatefulWidget {
  ...
  @override
  State<FeedPostWidget> createState() => FeedPostWidgetState();
}

class FeedPostWidgetState extends State<FeedPostWidget> {
            ...
            Padding(
              ...
              child: ListTile(
                ...
                trailing: PopupMenuButton<String>(
                  onSelected: (value) {
                    if (value == 'Report') {
                      _recipeController.reportRecipe(
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 5),
                    Text(
                        '${widget.post.comments.length}'), // Updated comment count
                  ],
                ),
              ),
